...
export default function NavigationMobile() {
    ...
    const galleryIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-12">
    ...
    return (
        <div className="absolute top-0 left-0 z-50 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
            ...
            <div className="w-[70dvw] h-screen bg-black bg-opacity-75 text-white pl-2 pt-4">
                ...
                <div className="flex w-[75%] h-[10%]">
                    <Link to="/galleries" onClick={() => toggleMenu(!showMenu)} className="w-full flex items-center justify-around">
                        {galleryIcon}
                        <p className="text-[36px] w-[50%]">Galleries</p>
                    </Link>
                </div>
            </div>
            }
